 ...
 * @time   10:47:15
 */
public class WelcomeToLevel1 extends JPanel{

    BufferedImage  img;
    Graphics g;
    Font pixelMplus;
    ArrayList<Point>color;
    public WelcomeToLevel1(JFrame frame){
        ...
        double step=255.00/47.00;                                               //for each r step g valis present.
        double r=0,g=0;
        for(r=0;r<=47;r++){
            for(double loop=0;loop<step;loop++){
                if(g>255)
                    break;
    ...
    public static void main(String[] args) {
        ...
        WelcomeToLevel1 wel=new WelcomeToLevel1(frame);
        frame.add(wel);
